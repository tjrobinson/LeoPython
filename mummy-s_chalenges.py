...
def create_grid():
    ...
    for x in range(0, 8):
        ...
        number2 = random.randint(0, 700)
        number = number1 + number2
        if number < 10:
            square = tkinter.Label(window, text = "    ", bg = "green")
        elif number == 1199:
            square = tkinter.Label(window, text = "    ", bg = "blue")
        elif number > 1199:
            square = tkinter.Label(window, text = "    ", bg = "red")
        else:
            square = tkinter.Label(window, text = "    ", bg = random.choice(colours))
        square.grid()
        column.append(square)
        grid.append(column)
def add_created_grid(window):
